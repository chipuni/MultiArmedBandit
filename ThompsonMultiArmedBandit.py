...
class ThompsonMultiArmedBandit(MultiArmedBandit):
    def choose_side(self):
        # We need at least one hit on each side for this chooser.
        ...
        probability = scipy.stats.ttest_ind_from_stats(mean1=mean1, std1=std1, nobs1=nobs1, mean2=mean2, std2=std2, nobs2=nobs2, equal_var=True, alternative='less').pvalue
